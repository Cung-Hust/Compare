...
class TableManager:
    ...
    def GatewayEventTriggerOutputRelayTable(self):
        return self.__gatewayEventTriggerOutputRelay.gatewayEventTriggerOutputRelay

    @property
    def GatewayEventTriggerInputDeviceMappingTable(self):
        return self.__gatewayEventTriggerInputDeviceMapping.gatewayEventTriggerInputDeviceMapping

    @property
    def GatewayEventTriggerInputDeviceSetupValueTable(self):
        return self.__gatewayEventTriggerInputDeviceSetupValue.gatewayEventTriggerInputDeviceSetupValue

    @property
    def GatewayEventTriggerTable(self):
        return self.__gatewayEventTrigger.gatewayEventTrigger
